...
def render_video(
    ...
    # text for the mode
    # if dim == 2:
    #     mode_text = ax.text(0.5, 0.99, "Mode={}", va="top", ha="center", **text_font_opts)
    ...
    def update(kk: int) -> list[plt.Artist]:
        ...
        # update the mode
        # if kk < len(rollout.T_cost):
        #     ave_speed = jnp.mean(jnp.linalg.norm(rollout.T_action[kk], axis=1))
        #     mode_text.set_text(f"Mode={ave_speed < 0.1}")
